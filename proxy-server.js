...
server.on('upgrade', (req, socket, head) => {
    const host = req.headers.host;
    console.log(`Proxy: Upgrading request for host: ${host}, path: ${req.url}`);
...
server.listen(PROXY_PORT, () => {
    ...
    console.log(`You can now access your app using subdomains like http://subdomain.localhost:${PROXY_PORT}`);
 });
